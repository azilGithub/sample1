		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Navigation",
									"targetURL": "#zbtpday6exercise3espinosa-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zbtpday6exercise3espinosa-display": {
								"semanticObject": "zbtpday6exercise3espinosa",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zbtp.day6exercise3espinosa",
									"url": sap.ui.require.toUrl("zbtp/day6exercise3espinosa")
								}
							}
						}
					}
